...
?>
                ...
                <div id="content-wrap">
                        ...
                        <div id="sidebar">
                                ...
                                <div class="left-box">
                                        <ul class="sidemenu">                                
                                                <li ><a href="index.php">CCNA-1</a></li>
                                                <li ><a href="index.php">CCNA-2</a></li>
                                                <li ><a href="index.php">CCNA-3</a></li>
                                                <li ><a href="index.php">CCNA-4</a></li>
                                        </ul>        
                                ...
                                <input type="hidden" name="search_form" value="true">
                                 ...
                                 <?php
                                  ...
                                  echo "<p><b><font color='black'>You have Successfully Logged out</font></b></p>";
                                 ?>
