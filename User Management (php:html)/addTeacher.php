                ...
                <div id="content-wrap">
                        ...
                        <div id="sidebar">
                                ...
                                ?>
                                                ...
                                                <li><a href="file_format.php?person=1">Uploaded File Format</a></li>
                                        <?php
                                        }
                                        ?>
                                        </ul>      
                                ...
                                <form method="POST" action="addTeacher.php" class="searchform">
                                ...
                                if($flag==1)
                                {
                                     ...
                                     if($tPass!=$tCPass){echo "Password Mismatch<br>";}
                                     else                                        
										{
													...
													$sql = "insert into user values('$id','$tpass',1)";
													$result = mysql_query($sql, $link);
													
													
													$result = mysql_query($sql, $link);
													$sql = "insert into teachers values('$id','$tn','$tfn','$tpass','$tdegree','$tadd','$tpadd','$tsex','$tmail','$tcontact',1)";
													$result = mysql_query($sql, $link);
